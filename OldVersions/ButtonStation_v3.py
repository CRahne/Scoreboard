...
Title_Label = Label(mainframe, image=PHOTO)
...
Count1_Label = Label(mainframe,textvariable=Count1,bg='black',fg='gold', font=f'Hack 50')
Count1_Label.grid(row=2, column=0, padx=50, pady=pady_Size)
...
Question_Label.grid(row=2, column=1,padx=50, pady=pady_Size)

Count2 = StringVar()
Count2.set("0")

Count2_Label = Label(mainframe,textvariable=Count2,bg='black',fg='gold', font=f'Hack 50')
Count2_Label.grid(row=2,column=2,padx=50, pady=pady_Size)
